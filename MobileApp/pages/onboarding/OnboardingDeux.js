    ...
    >
      <View style={styles.overlay}>
        ...
        <Text style={styles.loginText}>
          {t('onboarding.page_two.login_text')} <TouchableOpacity onPress={()=>{navigation.replace("Auth", { screen: "LogIn" })}}><Text style={styles.loginLink}>{t('onboarding.page_three.login_link')}</Text></TouchableOpacity>
        </Text>
      </View>
